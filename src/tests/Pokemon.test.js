...
describe('Teste se a pagina "Pokemon" renderiza corretamente.', () => {
  ...
  it(`A imagem do Pokémon deve ser exibida. Ela deve conter um atributo 'src' com a URL da imagem um atributo 'alt' com o texto '<name> sprite', onde '<name>' é o nome do pokémon`, () => {
    renderWithRouter(<Pokemon
      pokemon={ listaPokemons[0] }
      isFavorite={ false }
    />);
  ...
  it(`Verifica se o card do Pokémon indicado na Pokédex contém um link de navegação para exibir detalhes deste Pokémon. O link deve possuir a URL '/pokemons/<id>', onde '<id>' é o id do Pokémon exibido`, () => {
